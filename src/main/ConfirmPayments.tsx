        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            ...
            <h1 className="text-xl md:text-2xl font-semibold text-slate-900">
              Laporkan bukti transfer pemesanan Mandiri Express
            </h1>
            <p className="text-xs md:text-sm text-slate-600 max-w-xl">
              Isi form berikut setelah Anda melakukan transfer sesuai instruksi dari admin Mandiri Express.
              Tim kami akan memverifikasi dan memperbarui status pemesanan charter rombongan Anda.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="kode"
                      required
                      placeholder="Contoh: ME-REQ-2025-00123"
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        id="bank-tujuan"
                        required
                        placeholder="Contoh: BCA a.n PT Mandiri Express Indonesia"
                        className="h-10 text-sm border-slate-300 focus-visible:ring-red-500"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-col gap-3 rounded-lg border border-dashed border-slate-300 bg-slate-50 px-4 py-4">
                      ...
                      <Input
                        ...
                        type="file"
                        required
                        className="h-10 cursor-pointer bg-white text-sm file:mr-3 file:rounded-md file:border-0 file:bg-red-600 file:px-3 file:py-1 file:text-xs file:font-semibold file:text-white hover:file:bg-red-700"
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-col md:flex-row gap-3 md:items-center md:justify-between">
              <p className="text-[0.7rem] md:text-xs text-slate-500">
                ...
                Tim Mandiri Express akan menghubungi Anda jika diperlukan verifikasi tambahan.
              </p>
              <Button
                type="submit"
                className="w-full md:w-auto h-11 md:h-11 rounded-lg text-sm font-semibold bg-red-600 hover:bg-red-700 shadow-lg shadow-red-400/40 inline-flex items-center justify-center gap-2 px-6"
              >
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-[0.75rem] text-slate-500">
                      Lakukan transfer hanya ke rekening resmi di bawah ini atas nama PT Mandiri Express Indonesia.
                    </p>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between rounded-lg border border-dashed border-slate-300 bg-slate-50 px-4 py-3">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[0.7rem] text-slate-500">a.n PT Mandiri Express Indonesia</p>
                    </div>
                    <Button
                      type="button"
                      variant="outline"
              ...
              <CardContent className="p-5 md:p-6 space-y-4 text-xs md:text-sm">
                <div className="flex items-center justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-[0.75rem] text-slate-500">
                      Lihat ringkasan tagihan lengkap untuk pemesanan charter rombongan Anda.
                    </p>
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-slate-900">INV-ME-2025-00123</span>
                  </div>
                  <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  className="w-full h-9 rounded-lg bg-red-600 hover:bg-red-700 text-xs font-semibold text-white inline-flex items-center justify-center gap-2 shadow-md shadow-red-300"
                >
