...
export default function HeroSection() {
  ...
  const waLink = useMemo(() => {
    ...
    const msg =
      `Halo Mandiri Express, saya ingin charter bus.\n` +
      `Layanan: ${layanan}\n` +
      `Rute: ${asal} → ${tujuan}\n` +
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full">
              <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                  <button className="inline-flex justify-center items-center gap-2 bg-red-600 text-white px-6 py-3 rounded-lg shadow-lg font-medium hover:bg-red-700 transition w-full sm:w-auto">
                    Pesan Sekarang
                ...
                <DialogContent className="sm:max-w-lg">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Isi data berikut untuk cek ketersediaan dan mendapatkan estimasi harga.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <DialogFooter className="flex flex-col sm:flex-row gap-3 sm:justify-start w-full">
                    <a
                      ...
                      className="w-full inline-flex justify-center items-center gap-2 bg-red-600 text-white px-5 py-3 rounded-lg shadow-lg font-medium hover:bg-red-700 transition"
                    >
                      Minta Penawaran
                      <ArrowRight className="w-4 h-4" />
                    </a>
                    <a
                      ...
                      className="w-full inline-flex justify-center items-center gap-2 border border-red-200 text-red-700 px-5 py-3 rounded-lg font-medium hover:bg-red-50 transition"
                    >
                      Hubungi Admin
              ...
              <a
                href="#daftar-bus"
                className="inline-flex justify-center items-center gap-2 border border-red-200 text-red-700 px-6 py-3 rounded-lg font-medium hover:bg-red-50 transition w-full sm:w-auto"
              >
                Lihat Daftar Bus
              </a>
            </div>
